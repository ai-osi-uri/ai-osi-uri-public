...
USAGE = {
    ...
    "請求管理台帳": [
        ...
        *COMMON_HEAD,
        ...
        "請求書番号（INV-YYYY-MM-連番3桁、YYYY-MM=請求月）は osi-finance-invoice が発行するときに振ります。",
        ...
        "  月次請求スケジュール：契約ID=AR-C-001 / 対象月=2026-04 / 件名=業務委託（2026年4月分） / 請求額(税込)=220000 / 請求ステータス=未請求",
    ],
    "支払管理台帳": [
        ...
        *COMMON_HEAD,
        ...
        "",
        "記入例（参考。台帳には書かない）",
        "  支払先マスタ：支払先ID=V-001 / 支払先名=サンプル株式会社 / 支払先区分=法人 / 支払カテゴリ=外注費 / 取引先ID=P-001 /"
