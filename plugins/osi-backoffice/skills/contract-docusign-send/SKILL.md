...
ds_create_envelope(
  ...
  signers: [
    ...
    { name:"渚 有瓶",    email:"<乙メール>", routing_order:"2", anchor:"AI OSI URI" }
  ],
  carbon_copies: [{ name:"AI OSI URI 控え", email:"shared@ai-osi-uri.com" }],
  email_subject: "【AI OSI URI】<契約名> ご署名のお願い",
  email_blurb:   "<宛名と依頼文>"
)
```
