...
対象プラグイン: osi-creative, osi-creative-openrouter, osi-docs, osi-deploy, osi-knowledge, osi-finance, osi-backoffice
...
| plugins/osi-docs/skills/architecture-proposal/SKILL.md | 49 | Notion | 8. （任意）Drive 格納・Notion 反映は proposal-package の流儀に合わせる。v1モック画面＋Vercel |
